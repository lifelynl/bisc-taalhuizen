...
export const DownloadParticipationsModal: React.FunctionComponent<Props> = props => {
    ...
    return (
        <Form onSubmit={handleDownload}>
            <DownloadModal
                onClose={onClose}
                title={i18n._(t`Gegevens verwijzingen downloaden`)}
                text={i18n._(
                    t`Download een CSV bestand van alle verwijzingen van de deelnemers van dit Taalhuis. Selecteer een periode waarin de verwijzigingen zijn aangemaakt.`
                )}
                loading={loading}
