...
export const ActiveGroupsOverviewView: React.FunctionComponent = () => {
    ...
    return <ProviderGroupsOverviewContainer organizationId={organizationId} status={EducationGroupStatus.Active} />
}
