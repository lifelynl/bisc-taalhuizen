...
export const PastGroupsOverviewView: React.FunctionComponent = () => {
    ...
    return <ProviderGroupsOverviewContainer organizationId={organizationId} status={EducationGroupStatus.Past} />
}
