...
export const ParticipantLearningNeedReferralMentorAssignmentUpdateView: React.FunctionComponent<Props> = props => {
                ...
                <Form onSubmit={handleEdit}>
                    ...
                    <Column spacing={10}>
                        ...
                        {participation.mentor && (
                            <>
                                <HorizontalRule />
                                <SectionTitle title={i18n._(`Begeleider`)} heading={'H3'} />
