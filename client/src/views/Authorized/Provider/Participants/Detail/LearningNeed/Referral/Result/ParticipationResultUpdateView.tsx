...
import {
    ProviderParticipantDetailLearningNeedsDetailReferralsDetailTestResultRouteParams,
    providerRoutes,
} from 'routes/provider/providerRoutes'
import { SessionContext } from 'components/Providers/SessionProvider/context'

export const ParticipationResultUpdateView: React.FC = () => {
    const params = useParams<ProviderParticipantDetailLearningNeedsDetailReferralsDetailTestResultRouteParams>()
    ...
    async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        try {
            ...
            NotificationsManager.success(
                i18n._(t`Afronding is bijgewerkt`),
