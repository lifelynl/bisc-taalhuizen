...
export type QueryOrganizationsArgs = {
    ...
    rsin_list?: Maybe<Array<Maybe<Scalars['String']>>>
    chamberOfComerce?: Maybe<Scalars['String']>
    chamberOfComerce_list?: Maybe<Array<Maybe<Scalars['String']>>>
...
export type Image = Node & {
    ...
    description: Scalars['String']
    /** The alt of of this image for people with poor eyesight */
    alt?: Maybe<Scalars['String']>
...
export type MenuItem = Node & {
    ...
    description?: Maybe<Scalars['String']>
    /** The order in wichs this menu item is shown in relation to other items of the same menu */
